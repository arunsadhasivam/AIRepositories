...
if __name__ == '__main__':
    ...
    print("\nExample usage:")
    print("  curl http://localhost:5000/tools")
    print("  curl -X POST http://localhost:5000/tools/get_weather -H 'Content-Type: application/json' -d '{\"parameters\": {\"location\": \"New York\"}}'")
    print("  curl -X POST http://localhost:5000/invoke -H 'Content-Type: application/json' -d '{\"type\": \"tool\", \"name\": \"calculate\", \"parameters\": {\"expression\": \"2+2\"}}'")
