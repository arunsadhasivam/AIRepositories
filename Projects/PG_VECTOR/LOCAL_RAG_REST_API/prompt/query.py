...
#retriever response handing.
def configureAndProcessRetriever(query,search_type,vectorRetriever):
    """
    configure retriever and get the response.
    Args:
        query : prompt query
        search_type: hybrid or cosine
...
def getRetrieverAndGuadRailResponse(retriever,query):
    """
    Process the retriever response and guadtrail response.
    Args:
